	...
	<main class="container">
		<div class="row justify-content-md-center">
			<div class="ifd-form-wrapper col-md-6">
				...
				<h4 class="mt-3 mb-3">
					<strong>Passo 1: Dados do responsável do Restaurante</strong>
				</h4>

				<form action="cadastro-responsavel" class="row" method="post">
					<div class="mb-3">
					...
					<div>
						<input type="submit" class="btn btn-primary float-end" value="Cadastrar meu restaurante" />
					</div>
