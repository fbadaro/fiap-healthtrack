		...
		<div class="row vh-100">			
			<div class="ifd-login-auth-wrapper col-12 col-md-8 col-xl-4">
				<div class="ifd-login-auth">
					<span class="logo nutri">Ifood Nutri</span>
					
					<form action="dashboard-nutri" method="post">
			...
			<div class="ifd-login-wrapper nutri d-none d-md-block col-md-4 col-xl-8">
				<div class="disclaimer d-none d-lg-block">
					<h1>Faça parte da rede de Nutricionistas do Ifood.</h1>
					<p>Faça parcerias e ganhe muito mais!</p>

					<a href="cadastro-nutricionista.jsp" class="btn btn-outline-light btn-lg">Quero fazer parte!</a>
				</div>
			</div>
		</div>
	</main>
